use crate::gpgpu::descriptors::ConstructorTypes::*;
use crate::gpgpu::descriptors::KernelArg::*;
use crate::gpgpu::descriptors::KernelConstructor::*;
use crate::gpgpu::descriptors::Types::*;
use crate::gpgpu::Dim::{self, *};
use crate::gpgpu::DimDir::{self, *};
use crate::gpgpu::{
...
use crate::gpgpu::functions::Needed::*;
use Needed::*;
