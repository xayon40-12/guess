use crate::gpgpu::pde_parser::pde_ir::ir_helper::Indexable;
use crate::gpgpu::pde_parser::pde_lexer::range;
use crate::gpgpu::pde_parser::pde_lexer::GLOBAL_DIM;
use crate::gpgpu::pde_parser::pde_lexer::VARS;
use crate::gpgpu::pde_parser::SPDETokens::Symb;
use crate::gpgpu::pde_parser::DPDE;
use nom::branch::alt;
